...
$(document).ready(function () {
  $(window).scroll(function () {
    var top_of_element = $(".features-item").offset().top;
    var bottom_of_element =
      $(".features-item").offset().top + $(".features-item").outerHeight();
    ...
    if (
      ...
      // The element is visible, add bounce animation
      $(".features-item")
...
$(document).ready(function () {
  $(window).scroll(function () {
    var top_of_element = $(".services").offset().top;
    var bottom_of_element =
      $(".services").offset().top + $(".services").outerHeight();
    var bottom_of_screen = $(window).scrollTop() + $(window).innerHeight();
    var top_of_screen = $(window).scrollTop();
...
function openModalbyid(event, modalId) {
  ...
  if (modal) {
    ...
    // Add click event listener to close the modal if clicked outside
